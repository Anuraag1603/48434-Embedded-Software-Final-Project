...
#define ModeAsync 0
#define ModeSync 1
#define TestModeCommand 0x10
#define TariffCommand 0x11
#define Time1Command 0x12
#define Time2Command 0x13
#define PowerCommand 0x14
#define EnergyCommand 0x15
#define CostCommand 0x16
#define FrequencyCommand 0x17
#define VoltageCommand 0x18
#define CurrentCommand 0x19
#define PowerFactorCommand 0x1A
...
uint32_t test0, test1, test2, test3;
...
void HandleTariffCommand();
void HandleTime1Command();
void HandleTime2Command();
void HandlePowerCommand();
void HandleEnergyCommand();
void HandleCostCommand();
void HandleFrequencyCommand();
void HandleVoltageCommand();
void HandleCurrentCommand();
void HandlePowerFactorCommand();
...
//          valid = bTRUE;
        ...
        case CurrentCommand:
          ...
          valid = bTRUE;
        case PowerFactorCommand:
          HandlePowerFactorCommand();
          valid = bTRUE;
        default:
          valid = bFALSE;
          break;
...
void HandleTestModeCommand()
{
  DEM_Test(Packet_Parameter1);
}
void HandleTariffCommand()
{
  DEM_Tariff(Packet_Parameter1);
}
void HandleTime1Command()
{
  DEM_Time1(Packet_Parameter1, Packet_Parameter2);
}
void HandleTime2Command()
{
  DEM_Time2(Packet_Parameter1, Packet_Parameter2);
}
void HandlePowerCommand()
{
  DEM_Power(Packet_Parameter1, Packet_Parameter2);
}
void HandleEnergyCommand()
{
  DEM_Energy_Pro(Packet_Parameter1, Packet_Parameter2);
}
void HandleCostCommand()
{
  DEM_Cost_Pro(Packet_Parameter1, Packet_Parameter2);
}
void HandleFrequencyCommand()
{
  DEM_Frequency(Packet_Parameter1, Packet_Parameter2);
}
void HandleVoltageCommand()
{
  DEM_Voltage(Packet_Parameter1, Packet_Parameter2);
}
void HandleCurrentCommand()
{
  DEM_Current(Packet_Parameter1, Packet_Parameter2);
}
void HandlePowerFactorCommand()
{
  DEM_Power_Factor(Packet_Parameter1, Packet_Parameter2);
}
